...
/* 12 */
/*!***********************************************************************************!*\
  !*** C:/Users/Admin/Desktop/wxdoutu/doutu/main.js?{"page":"pages%2Fhome%2Fhome"} ***!
  \***********************************************************************************/
...
/* 13 */
/*!****************************************************************!*\
  !*** C:/Users/Admin/Desktop/wxdoutu/doutu/pages/home/home.vue ***!
  \****************************************************************/
/*! no static exports found */
...
/* harmony import */ var _home_vue_vue_type_style_index_0_id_92bb8f34_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./home.vue?vue&type=style&index=0&id=92bb8f34&scoped=true&lang=css& */ 23);
...
/* 14 */
/*!***********************************************************************************************************!*\
  !*** C:/Users/Admin/Desktop/wxdoutu/doutu/pages/home/home.vue?vue&type=template&id=92bb8f34&scoped=true& ***!
  \***********************************************************************************************************/
...
/* 16 */
/*!*****************************************************************************************!*\
  !*** C:/Users/Admin/Desktop/wxdoutu/doutu/pages/home/home.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 17 */
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Admin/Desktop/wxdoutu/doutu/pages/home/home.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni, uniCloud) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var classification = function classification() {__webpack_require__.e(/*! require.ensure | component/classification/classification */ "component/classification/classification").then((function () {return resolve(__webpack_require__(/*! ../../component/classification/classification.vue */ 66));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  onLoad: function onLoad() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var db, collection2, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              uni.showLoading({
                title: "加载中" });

              db = uniCloud.database();
              collection2 = db.collection("imagefile");
              _this.getBanner(_this, db, collection2);_context.next = 6;return (
                _this.getData(db, collection2));case 6:data = _context.sent;
              _this.dataArr = data;
  ...
  methods: {
    ...
    getBanner: function () {var _getBanner = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(vm, db, collection) {var random, res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                random = parseInt(Math.random() * (800 + 1), 10);_context2.next = 3;return (
                  collection.where({
                    type: "蘑菇头" }).
                  skip(random).limit(5).get());case 3:res = _context2.sent;
                vm.bannerArr = res.result.data;case 5:case "end":return _context2.stop();}}}, _callee2);}));function getBanner(_x, _x2, _x3) {return _getBanner.apply(this, arguments);}return getBanner;}(),

    getData: function getData(db, collection) {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var arr, i, random, res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                arr = [];
                i = 0;case 2:if (!(i < _this2.typeArr.length)) {_context3.next = 11;break;}
                random = parseInt(Math.random() * (800 + 1), 10);_context3.next = 6;return (
                  collection.where({
                    type: _this2.typeArr[i] }).
                  skip(random).limit(4).get());case 6:res = _context3.sent;
                arr[i] = {
                  type: _this2.typeArr[i],
                  data: res.result.data,
                  i: i };case 8:i++;_context3.next = 2;break;case 11:return _context3.abrupt("return",


                arr);case 12:case "end":return _context3.stop();}}}, _callee3);}))();
    },
    upload: function upload(obj) {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var i, type, random, db, collection, res;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:

                i =

                obj.i, type = obj.type;
                random = parseInt(Math.random() * (800 + 1), 10);
                db = uniCloud.database();
                collection = db.collection("imagefile");_context4.next = 6;return (
                  collection.where({
                    type: type }).
                  skip(random).limit(4).get());case 6:res = _context4.sent;
                _this3.dataArr.splice(i, 1, {
                  data: res.result.data,
                  i: i,
                  type: type });case 8:case "end":return _context4.stop();}}}, _callee4);}))();
...
/* 23 */
/*!*************************************************************************************************************************!*\
  !*** C:/Users/Admin/Desktop/wxdoutu/doutu/pages/home/home.vue?vue&type=style&index=0&id=92bb8f34&scoped=true&lang=css& ***!
  \*************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
